...
namespace I18nBundle\Document\Helper;

use Pimcore\Model\Site as PimcoreSite;

class DocumentRelationHelper
{
    /**
     ...
     *
     * @return string document url without trailing slash
     */
    public function getDocumentUrl($document = NULL, $returnAsArray = FALSE, $restrictToCurrentSite = TRUE)
    {
     ...
     * @return bool
     */
    public function isDocumentInCurrentSite($document)
    {
        if (!\Pimcore\Model\Site::isSiteRequest()) {
            return FALSE;
        }
